  ...
  return (
    <article className="space-y-8">
      <div className="mb-10">
        ...
        >
          {t('companyPage.back')}
          <span>/ Продукти і супермаркети /</span>
          {/* {t('companyPage.back')} */}
          <span>АТБ-Маркет №679</span>
          {/* {t('companyPage.back')} */}
        </Link>
      </div>
            ...
            <div className="flex min-h-[742px] w-full max-w-[884px] flex-col gap-4 rounded-[20px] bg-white">
              <div className="flex h-auto min-h-[196px] w-full max-w-[884px] flex-col gap-5 rounded-[20px] bg-[#E7E7E7] p-10">
                <div className="space-y-2">
                  <h1 className="font-eUkraine font-regular mb-2 text-[28px] leading-[32px] text-black">
                    {company.name}
                  </h1>
